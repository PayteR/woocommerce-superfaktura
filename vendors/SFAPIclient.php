...
class SFAPIclient{
	...
	public function deleteInvoiceItem($invoice_id, $item_id) {
		...
		try{
			$response = Requests::get($this->getConstant('SFAPI_URL').'/invoice_items/delete/'.$item_id.'/invoice_id:'.$invoice_id, $this->headers, $this->requestOptions);
	...
	public function deleteExpense($id) {
		...
		try{
			$response = Requests::get($this->getConstant('SFAPI_URL').'/expenses/delete/'.$id, $this->headers, $this->requestOptions);
			$response_data = json_decode($response->body);
			return $response_data;
		}
		catch (Exception $e) {
	...
	public function clients($params = [], $list_info = true){
		...
		try{
			$response = Requests::get($this->getConstant('SFAPI_URL').'/clients/index.json'.$this->_getRequestParams($params, $list_info), $this->headers, $this->requestOptions);
			$response_data = json_decode($response->body);
			return $response_data;
		}
		catch (Exception $e) {
	...
	public function delete($id){
		...
		try{
			$response = Requests::get($this->getConstant('SFAPI_URL').'/invoices/delete/'.$id, $this->headers, $this->requestOptions);
			$response_data = json_decode($response->body);
			return $response_data;
		}
		catch (Exception $e) {
	...
	public function deleteStockItem($id) {
		...
		try{
			$response = Requests::get($this->getConstant('SFAPI_URL').'/stock_items/delete/'.$id, $this->headers, $this->requestOptions);
			$response_data = json_decode($response->body);
			return $response_data;
		}
		catch (Exception $e) {
	...
	public function expenses($params = [], $list_info = true){
		...
		try{
			$response = Requests::get($this->getConstant('SFAPI_URL').'/expenses/index.json'.$this->_getRequestParams($params, $list_info), $this->headers, $this->requestOptions);
			$response_data = json_decode($response->body);
			return $response_data;
		}
		catch (Exception $e) {
	...
	public function getCountries(){
		try{
			$response = Requests::get($this->getConstant('SFAPI_URL').'/countries', $this->headers, $this->requestOptions);
	...
	public function getSequences(){
		try{
			$response = Requests::get($this->getConstant('SFAPI_URL').'/sequences/index.json', $this->headers, $this->requestOptions);
			return json_decode($response->body);
		}
		catch (Exception $e) {
			return $this->exceptionHandling($e);
	...
	public function getTags(){
		try{
			$response = Requests::get($this->getConstant('SFAPI_URL').'/tags/index.json', $this->headers, $this->requestOptions);
			return json_decode($response->body);
		}
		catch (Exception $e) {
			return $this->exceptionHandling($e);
	...
	public function getPDF($invoice_id, $token, $language = 'slo'){
		try{
			...
			$response = Requests::get($this->getConstant('SFAPI_URL').'/'.$language.'/invoices/pdf/'.$invoice_id.'/token:'.$token, $this->headers, $this->requestOptions);
	...
	public function invoice($id){
		...
		try{
			$response = Requests::get($this->getConstant('SFAPI_URL').'/invoices/view/'.$id.'.json', $this->headers, $this->requestOptions);
			$response_data = json_decode($response->body);
			return $response_data;
		}
		catch (Exception $e) {
	...
	public function invoices($params = [], $list_info = true){
		...
		try{
			$response = Requests::get($this->getConstant('SFAPI_URL').'/invoices/index.json'.$this->_getRequestParams($params, $list_info), $this->headers, $this->requestOptions);
			$response_data = json_decode($response->body);
			return $response_data;
		}
		catch (Exception $e) {
	...
	public function expense($id){
		...
		try{
			$response = Requests::get($this->getConstant('SFAPI_URL').'/expenses/edit/'.$id.'.json', $this->headers, $this->requestOptions);
			$response_data = json_decode($response->body);
			return $response_data;
		}
		catch (Exception $e) {
	...
	public function stockItem($id){
		...
		try{
			$response = Requests::get($this->getConstant('SFAPI_URL').'/stock_items/edit/'.$id.'.json', $this->headers, $this->requestOptions);
			$response_data = json_decode($response->body);
			return $response_data;
		}
		catch (Exception $e) {
	...
	public function stockItems($params = [], $list_info = true){
		...
		try{
			$response = Requests::get($this->getConstant('SFAPI_URL').'/stock_items/index.json'.$this->_getRequestParams($params, $list_info), $this->headers, $this->requestOptions);
			$response_data = json_decode($response->body);
			return $response_data;
		}
		catch (Exception $e) {
	...
	public function setInvoiceLanguage($id, $lang = 'slo') {
		...
		try{
			$response = Requests::get($this->getConstant('SFAPI_URL').'/invoices/setinvoicelanguage/'.$id.'/lang:'.$lang, $this->headers, $this->requestOptions);
			$response_data = json_decode($response->body);
			return $response_data;
		}
		catch (Exception $e) {
	...
	public function getLogos(){
		try{
			$response = Requests::get($this->getConstant('SFAPI_URL').'/users/logo', $this->headers, $this->requestOptions);
			return json_decode($response->body);
		}
		catch (Exception $e) {
			return $this->exceptionHandling($e);
	...
	public function getExpenseCategories(){
		try{
			$response = Requests::get($this->getConstant('SFAPI_URL').'/expenses/expense_categories', $this->headers, $this->requestOptions);
			return json_decode($response->body);
		}
		catch (Exception $e) {
			return $this->exceptionHandling($e);
...
class SFAPIclientAT extends SFAPIclient {
	const
		SFAPI_URL = 'https://meine.superfaktura.at';
}
